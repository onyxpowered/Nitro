 ...
 *
 * ```js
 * const map = new Nitro.TextureLoader().load( 'textures/sprite.png' );
 * const material = new Nitro.SpriteMaterial( { map: map, color: 0xffffff } );
 *
 * const sprite = new Nitro.Sprite( material );
