 ...
 * 	const x = Nitro.MathUtils.randFloatSpread( 2000 );
 * 	const y = Nitro.MathUtils.randFloatSpread( 2000 );
 * 	const z = Nitro.MathUtils.randFloatSpread( 2000 );
 *
 * 	vertices.push( x, y, z );
 * }
 *
 * const geometry = new Nitro.BufferGeometry();
 * geometry.setAttribute( 'position', new Nitro.Float32BufferAttribute( vertices, 3 ) );
 * const material = new Nitro.PointsMaterial( { color: 0x888888 } );
 * const points = new Nitro.Points( geometry, material );
 * scene.add( points );
 * ```
 *
 * @augments Material
