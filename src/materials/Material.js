...
class Material extends EventDispatcher {
	...
	constructor() {
		...
		/**
		 * User-defined clipping planes specified as Nitro.Plane objects in world
		 * space. These planes apply to the objects this material is attached to.
		 * Points in space whose signed distance to the plane is negative are clipped
		 * (not rendered). This requires {@link NitroRenderer#localClippingEnabled} to
		 * be `true`.
		 *
		 * @type {?Array<Plane>}
		 * @default null
	 ...
	 *
	 * This method is used when rendering with {@link NitroRenderer}.
	 *
	 * @param {{vertexShader:string,fragmentShader:string,uniforms:Object}} shaderobject - The object holds the uniforms and the vertex and fragment shader source.
	 * @param {NitroRenderer} renderer - A reference to the renderer.
	 */
	...
	setValues( values ) {
		...
		for ( const key in values ) {
			...
			if ( currentValue === undefined ) {
				...
				warn( `Material: '${ key }' is not a property of Nitro.${ this.type }.` );
				continue;
