...
class Object3D extends EventDispatcher {
	...
	constructor() {
		 ...
		 *
		 * Only relevant in context of {@link NitroRenderer}.
		 *
		...
		/**
		 * The physics body bound to this object by {@link PhysicsWorld#addBody}, or
		 * `null` if this object has no physics simulation attached.
		 *
		 * @type {?CANNON.Body}
		 * @default null
		 */
	...
	add( object ) {
		...
		if ( object && object.isObject3D ) {
			...
			error( 'Object3D.add: object not an instance of Nitro.Object3D.', object );
