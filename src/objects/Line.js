 ...
 *
 * ```js
 * const material = new Nitro.LineBasicMaterial( { color: 0x0000ff } );
 *
 * const points = [];
 * points.push( new Nitro.Vector3( - 10, 0, 0 ) );
 * points.push( new Nitro.Vector3( 0, 10, 0 ) );
 * points.push( new Nitro.Vector3( 10, 0, 0 ) );
 *
 * const geometry = new Nitro.BufferGeometry().setFromPoints( points );
 *
 * const line = new Nitro.Line( geometry, material );
 * scene.add( line );
 * ```
 *
 * @augments Object3D
