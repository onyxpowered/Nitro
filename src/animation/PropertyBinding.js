...
class PropertyBinding {
	...
	static parseTrackName( trackName ) {
		...
		if ( matches === null ) {
			...
			throw new Error( 'Nitro.PropertyBinding: Cannot parse trackName: ' + trackName );
		...
		if ( results.propertyName === null || results.propertyName.length === 0 ) {
			...
			throw new Error( 'Nitro.PropertyBinding: can not parse propertyName from trackName: ' + trackName );
