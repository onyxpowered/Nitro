...
class KeyframeTrack {
	...
	constructor( name, times, values, interpolation ) {
		...
		if ( name === undefined ) throw new Error( 'Nitro.KeyframeTrack: track name is undefined' );
		if ( times === undefined || times.length === 0 ) throw new Error( 'Nitro.KeyframeTrack: no keyframes in track named ' + name );
